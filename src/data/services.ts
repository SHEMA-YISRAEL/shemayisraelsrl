    ...
    services: [
      {
        ...
        name: { es: "Consultas Ginecológicas", en: "Gynecological Consultations" },
        description: {
    ...
    services: [
      {
        ...
        name: { es: "Fisioterapia Traumatológica", en: "Traumatological Physiotherapy" },
        description: {
      ...
      },
      {
        ...
        name: { es: "Fisioterapia Reumatológica", en: "Rheumatological Physiotherapy" },
        description: {
      ...
      },
      {
        ...
        name: { es: "Fisioterapia Dermatofuncional", en: "Dermatofunctional Physiotherapy" },
        description: {
      ...
      },
      {
        ...
        name: { es: "Fisioterapia Respiratoria", en: "Respiratory Physiotherapy" },
        description: {
      ...
      },
      {
        ...
        name: { es: "Fisioterapia Neurológica", en: "Neurological Physiotherapy" },
        description: {
    ...
    services: [
      {
        ...
        name: { es: "Evaluaciones Psicológicas", en: "Psychological Evaluations" },
        description: {
...
export const neshimaServices: ServiceCategory[] = [
  {
    ...
    services: [
      ...
      },
      {
        ...
        name: { es: "Tratamientos Intensivos", en: "Intensive Treatments" },
        description: {
          es: "Programas intensivos para resultados visibles en menor tiempo.",
          en: "Intensive programs for visible results in less time."
        },
        icon: "sparkles",
        image: "/neshima/services/intensivo.jpg"
      },
      {
        id: "depilacion-ipl",
  ...
  },
  {
    ...
    services: [
      ...
      {
        id: "peeling-quimico",
        name: { es: "Peeling Químico", en: "Chemical Peeling" },
        description: {
          es: "Renovación celular para una piel más luminosa y uniforme.",
          en: "Cellular renewal for brighter and more even skin."
        },
        icon: "layers",
        image: "/neshima/services/peeling.jpg"
      },
      {
        id: "hifu",
        name: { es: "HIFU", en: "HIFU" },
        description: {
          es: "Ultrasonido focalizado de alta intensidad para rejuvenecimiento facial.",
          en: "High-intensity focused ultrasound for facial rejuvenation."
        },
        icon: "waves",
        image: "/neshima/services/hifu.jpg"
      },
      {
        id: "dermaplaning",
        name: { es: "Dermaplaning", en: "Dermaplaning" },
        description: {
          es: "Exfoliación física que elimina vello fino y células muertas.",
          en: "Physical exfoliation that removes fine hair and dead cells."
        },
        icon: "blade",
        image: "/neshima/services/dermaplaning.jpg"
      },
      {
        id: "telangiectasias",
        name: { es: "Tratamiento de Telangiectasias", en: "Telangiectasia Treatment" },
        description: {
          es: "Eliminación de arañas vasculares y capilares dilatados.",
          en: "Removal of spider veins and dilated capillaries."
        },
        icon: "target",
        image: "/neshima/services/telangiectasias.jpg"
      }
    ]
  }
];
    ...
    services: [
      {
        ...
        name: { es: "Emergencias y Urgencias en Salud", en: "Health Emergencies and Urgencies" },
        description: {
        ...
        icon: "ambulance",
        image: "/yeshiva/services/emergencias.jpg"
      },
      {
        id: "enfermeria",
        ...
        icon: "nurse",
        image: "/yeshiva/services/enfermeria.jpg"
      },
      {
        ...
        icon: "microscope-lab",
        image: "/yeshiva/services/laboratorio.jpg"
      }
    ]
  }
];
